...
export default function Sidebars({
  ...
  const layers = useStorage((root) => root.layers as Map<string, any>);
    ...
    <>
      ...
      {!leftIsMinimized ? (
          ...
          <div className="flex flex-col gap-1 p-4">
            ...
            {layerIds &&
              reversedLayerIds.map((id) => {
                ...
                const isSelected = Array.isArray(selection) ? selection.includes(id) : false;
        ...
        <div className="fixed left-3 top-3 flex h-[48px] w-[250px] items-center justify-between rounded-xl border bg-white p-4">
          ...
          <h2 className="scroll-m-20 text-[13px] font-medium">Room 1</h2>
          <PiSidebarSimpleThin
